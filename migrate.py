"""
Niva Bupa CRM Migration (SQLite) — Changed 2026-05-04
======================================================
Now creates Staff table and stores both staff_id + name in all person fields.
Usage: python migrate.py <inside_sales.csv> <ops_tracker.xlsx>
"""
