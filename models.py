...
class Patient(Base):
    ...
    alt_number = Column(String(100))
    condition_type = Column(String(100))
    plan_purchase_date = Column(String(100))
    plan_duration = Column(String(50))
    plan_price = Column(String(100))
    ...
    rm_call_booked = Column(String(50))
    sales_remarks = Column(Text)
    payment_month = Column(String(100))
    week_no = Column(String(50))
    created_at = Column(DateTime, default=now_ist)
...
class RMData(Base):
    ...
    welcome_call_done = Column(String(50))
    welcome_call_completion_date = Column(String(100))
    welcome_call_booked_not_completed = Column(String(50))
    metabolic_assessment = Column(String(50))
    ...
    cs_call_date = Column(String(100))
    cs_call_time = Column(String(100))
...
class MonthlyCycle(Base):
    ...
    assessment_done = Column(String(50))
    assessment_date = Column(String(100))
    plan_assigned = Column(String(50))
    plan_date = Column(String(100))
    plan_comments = Column(Text)
    exercise_plan_assigned = Column(String(50))
    exercise_plan_date = Column(String(100))
    exercise_plan_comments = Column(Text)
    followup_done = Column(String(50))
    followup_date = Column(String(100))
...
class Task(Base):
    ...
    status = Column(String(50), default="open")  # open, done
